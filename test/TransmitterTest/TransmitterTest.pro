...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../../lib/static/VideoTransmitterByTcp/release/ -lVideoTransmitterByTcp
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../../lib/static/VideoTransmitterByTcp/debug/ -lVideoTransmitterByTcp
else:unix:!macx: LIBS += -L$$OUT_PWD/../../lib/static/VideoTransmitterByTcp/ -lVideoTransmitterByTcp

INCLUDEPATH += $$PWD/../../lib/static/VideoTransmitterByTcp
DEPENDPATH += $$PWD/../../lib/static/VideoTransmitterByTcp

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/VideoTransmitterByTcp/release/libVideoTransmitterByTcp.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/VideoTransmitterByTcp/debug/libVideoTransmitterByTcp.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/VideoTransmitterByTcp/release/VideoTransmitterByTcp.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/VideoTransmitterByTcp/debug/VideoTransmitterByTcp.lib
else:unix:!macx: PRE_TARGETDEPS += $$OUT_PWD/../../lib/static/VideoTransmitterByTcp/libVideoTransmitterByTcp.a
